...
# ---------------------------------------------------------------------------
DEFAULT_PRODUCER_DELAY_SECONDS = float(
    getenv("PRODUCER_DELAY_SECONDS", "0.1")
)
...
# real-time-fraud-detection/data/raw/paysim.csv
DEFAULT_DATASET_PATH = getenv(
    "PAYSIM_DATASET_PATH",
    "data/raw/paysim.csv",
)